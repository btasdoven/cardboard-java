...
/**
 * Created by Batuhan on 30.5.2015.
 */
public class Sphere {
    ...
    public void draw() {
        ...
        GLES10.glBindTexture(GLES10.GL_TEXTURE_2D, this.mTextures[0]);
        ...
        for (int i = 0; i < this.mTotalNumStrips; i++) {
            GLES10.glVertexPointer(AMOUNT_OF_NUMBERS_PER_VERTEX_POINT, GLES10.GL_FLOAT, 0, this.mVertexBuffer.get(i));
            GLES10.glTexCoordPointer(AMOUNT_OF_NUMBERS_PER_TEXTURE_POINT, GLES10.GL_FLOAT, 0, this.mTextureBuffer.get(i));

            // Draw the vertices as triangle strip.
            GLES10.glDrawArrays(GLES10.GL_TRIANGLE_STRIP, 0, this.mVertices.get(i).length / AMOUNT_OF_NUMBERS_PER_VERTEX_POINT);
        }
